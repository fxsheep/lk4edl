...
////	patch_pbl(0x104130, 0xEAFFFFFE);
	...
	patch_pbl(0x10DA00, 0xE59F102C);
        patch_pbl(0x10DA04, 0xE59F202C);
        patch_pbl(0x10DA08, 0xE5812000);
        patch_pbl(0x10DA0C, 0xE59F1028);
        patch_pbl(0x10DA10, 0xE59F2028); 
	patch_pbl(0x10DA14, 0xE5812000); 
        patch_pbl(0x10DA18, 0xE59F1024);
        patch_pbl(0x10DA1C, 0xE59F201C);
        patch_pbl(0x10DA20, 0xE5812000);
        patch_pbl(0x10DA24, 0xE59F101C);
        patch_pbl(0x10DA28, 0xE59F2010);
        patch_pbl(0x10DA2C, 0xE5812000);
        patch_pbl(0x10DA30, 0xE8BD81F0);
        patch_pbl(0x10DA34, 0x0801F50E);
        patch_pbl(0x10DA38, 0x2001E002);
        patch_pbl(0x10DA3C, 0x0805BBE5);
        patch_pbl(0x10DA40, 0xDEADBEEF);
        patch_pbl(0x10DA44, 0x0805BBF5);
        patch_pbl(0x10DA48, 0x0805BC05);
